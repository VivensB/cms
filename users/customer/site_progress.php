                  ...
                  ?>
                    <td>
                      <div class="d-flex justify-content-start">
                        <a href="edit-site-progress-data.php?report=<?php echo $row['id']; ?>" type="link"
                        ...
                        <a type="link" onclick="return confirm('Are you sure to delete this report ?')"
                          href="delete-site-progress-report.php?report=<?php echo $row['id']; ?>"
                          class="btn btn-danger btn-sm">
                          <i class="fas bx bx-x"></i> Delete</a>
                      </div>
                    </td>
                    </tr>
                    <?php } ?>
